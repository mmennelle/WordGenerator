...
def generate_wordlist(adjective, noun, verb, reversible, filename, total_passwords, capitalize_adjective, 
                     capitalize_noun, capitalize_verb, max_length, use_symbols=False, symbols=None):
    with open(filename, 'w') as file:
        generated_count = 0
